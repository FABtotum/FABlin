...
/*
  ...
  #define REV_E_DIR() { if(current_block->active_extruder == 2) { WRITE(E2_DIR_PIN, INVERT_E2_DIR); } else { if(current_block->active_extruder == 1) { WRITE(E1_DIR_PIN, INVERT_E1_DIR); } else { WRITE(E0_DIR_PIN, INVERT_E0_DIR); }}}
    ...
    #define WRITE_E_STEP(v) { \
      if (extruder_duplication_enabled) { \
        WRITE(E0_STEP_PIN, v^INVERT_E_STEP_PIN^INVERT_E0_STEP_PIN); WRITE(E1_STEP_PIN, v^INVERT_E_STEP_PIN^INVERT_E1_STEP_PIN); \
  ...
  #endif
#else
  #define WRITE_E_STEP(v) WRITE(E0_STEP_PIN, v^INVERT_E_STEP_PIN^INVERT_E0_STEP_PIN)
